#include "f5android_plugins_f5_F5Buffers.h"
#include <jni.h>
#include <stdlib.h>
#include <stdio.h>
...
JNIEXPORT jobject JNICALL Java_f5android_plugins_f5_F5Buffers_initImage
...
JNIEXPORT jobject JNICALL Java_f5android_plugins_f5_F5Buffers_initCoeffs
...
JNIEXPORT jobject JNICALL Java_f5android_plugins_f5_F5Buffers_initHuffmanBuffer
...
JNIEXPORT jobject JNICALL Java_f5android_plugins_f5_F5Buffers_initHuffmanDecodeBuffer
...
JNIEXPORT jobject JNICALL Java_f5android_plugins_f5_F5Buffers_initPermutation
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setPixelValues
...
JNIEXPORT jint JNICALL Java_f5android_plugins_f5_F5Buffers_getPixelValue
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setYValues
...
JNIEXPORT jfloat JNICALL Java_f5android_plugins_f5_F5Buffers_getYValue
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setCr1Values
(JNIEnv *env, jobject obj, jobject pntr, float value, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT jfloat JNICALL Java_f5android_plugins_f5_F5Buffers_getCr1Value
(JNIEnv *env, jobject obj, jobject pntr, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setCb1Values
(JNIEnv *env, jobject obj, jobject pntr, float value, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT jfloat JNICALL Java_f5android_plugins_f5_F5Buffers_getCb1Value
(JNIEnv *env, jobject obj, jobject pntr, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setCr2Values
(JNIEnv *env, jobject obj, jobject pntr, float value, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT jfloat JNICALL Java_f5android_plugins_f5_F5Buffers_getCr2Value
(JNIEnv *env, jobject obj, jobject pntr, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setCb2Values
(JNIEnv *env, jobject obj, jobject pntr, float value, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT jfloat JNICALL Java_f5android_plugins_f5_F5Buffers_getCb2Value
(JNIEnv *env, jobject obj, jobject pntr, int x, int y)
{
	F5Image* f5 = (F5Image*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setCoeffValues
(JNIEnv *env, jobject obj, jobject pntr, jintArray values, int v_len, int start)
{
...
JNIEXPORT jint JNICALL Java_f5android_plugins_f5_F5Buffers_getCoeffValue
(JNIEnv *env, jobject obj, jobject pntr, int pos)
{
	F5Coeffs* f5 = (F5Coeffs*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setHuffmanBufferValues
(JNIEnv *env, jobject obj, jobject pntr, jintArray values, int v_len, int start)
{
...
JNIEXPORT jint JNICALL Java_f5android_plugins_f5_F5Buffers_getHuffmanBufferValue
(JNIEnv *env, jobject obj, jobject pntr, int pos)
{
	F5HuffmanBuffer* f5 = (F5HuffmanBuffer*) env->GetDirectBufferAddress(pntr);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setHuffmanDecodeBufferValues
...
JNIEXPORT jint JNICALL Java_f5android_plugins_f5_F5Buffers_getHuffmanDecodeBufferValue
  (JNIEnv *env, jobject obj, jobject pntr, int pos)
{
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_setPermutationValues
  (JNIEnv *env, jobject obj, jobject pntr, jintArray values, int v_len, int start)
{
...
JNIEXPORT jint JNICALL Java_f5android_plugins_f5_F5Buffers_getPermutationValue
  (JNIEnv *env, jobject obj, jobject pntr, int pos)
{
	F5Permutation* f5 = (F5Permutation*) env->GetDirectBufferAddress(pntr);
	return f5->buffer[pos];
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_cleanUpImage
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_cleanUpCoeffs
(JNIEnv *env, jobject obj, jobject pntr)
{
	F5Coeffs* f5 = (F5Coeffs*) env->GetDirectBufferAddress(pntr);
	delete(f5);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_cleanUpHuffmanBuffer
(JNIEnv *env, jobject obj, jobject pntr)
{
	F5HuffmanBuffer* f5 = (F5HuffmanBuffer*) env->GetDirectBufferAddress(pntr);
	delete(f5);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_cleanUpHuffmanDecodeBuffer
(JNIEnv *env, jobject obj, jobject pntr)
{
	F5HuffmanDecodeBuffer* f5 = (F5HuffmanDecodeBuffer*) env->GetDirectBufferAddress(pntr);
	delete(f5);
...
JNIEXPORT void JNICALL Java_f5android_plugins_f5_F5Buffers_cleanUpPermutation
(JNIEnv *env, jobject obj, jobject pntr)
{
	F5Permutation* f5 = (F5Permutation*) env->GetDirectBufferAddress(pntr);
	delete(f5);
